...
class BaseLitModel(pl.LightningModule):
    ...
    def __init__(self, model, args: argparse.Namespace = None):
        ...
        self.train_acc = Accuracy(task="multiclass", num_classes=84)
        self.val_acc = Accuracy(task="multiclass", num_classes=84)
        self.test_acc = Accuracy(task="multiclass", num_classes=84)
